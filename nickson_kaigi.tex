...
\begin{itemize}
    \item Contributed to the successful development of the "Journey" component of the Sumfully SaaS, streamlining inventory management for Amazon and Arbitrage sellers.
...
\begin{itemize}
    \item Contributed to the successful development of the Personal Case Based Teaching (PCBT) prototype that aimed to analyze past judgments in courts of law in a bid to determine judgmental bias.
...
\begin{itemize}
    \item Contributed to the successful development of the mPort project that tracked mobile phone number portability across mobile network operators in New Zealand, resulting in seamless mobile network operator migration.
    \item Successfully developed a search tool for custom Toll Free numbers that lead to an increase in toll free number uptake from users.
    \item Developed Lua scripts that allowed customization of Freeswitch, simplifying customization tasks for the network operation team 
...
\begin{itemize}
    \item Contributed to a database redesign and upgrade on the Domains Bot project that resulted in faster database queries and shorter API response times.
...
\begin{itemize}
    \item Contributed to the successful development of the "Balance Credit" web project that created the on-boarding process for customers of the Company's Pay Day loans product.
...
\begin{itemize}
    \item Successfully developed a mobile version of the A1 ERP. 
